...
function removeFact() {
  ...
  //get the div element below the click here button using the id and set it equal to variable
...
function addBlueBackground() {
  ...
  //get the div element below the click here button using the id and set it to variable
  var factDiv = document.getElementById("FactBox");
...
//get the Toggle Bernie button and store into the variable called bernieBtn
